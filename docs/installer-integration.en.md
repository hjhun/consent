# Platform Installer integration handoff
...
See [installation authority](installation-authority.en.md) for the implemented
provisioning tool and [CEP section 14](CEP_Consent_Framework.md) for design intent.
